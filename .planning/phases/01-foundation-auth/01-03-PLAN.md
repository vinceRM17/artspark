...
IMPORTANT:
- Call useSession() at component level (not inside handleSignIn) to avoid React hooks rules violation
...
- Call useSession() at component level for both verifyOtp and signIn (resend)
